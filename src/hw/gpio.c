...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
{
  ...
  {GPIOB, GPIO_PIN_3,  _DEF_OUTPUT,   GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_HIGH},    //  9. StepE0_EN
	...
	{GPIOA, GPIO_PIN_6,  _DEF_OUTPUT,   GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 12. ADC_Touch_xp
	{GPIOA, GPIO_PIN_5,  _DEF_OUTPUT,   GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW },    // 13. ADC_Touch_ym
  ...
  {GPIOA, GPIO_PIN_10, _DEF_OUTPUT,   GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},     // 21. Touch_xm
  {GPIOA, GPIO_PIN_9,  _DEF_OUTPUT,   GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW },    // 22. Touch_yp
};
